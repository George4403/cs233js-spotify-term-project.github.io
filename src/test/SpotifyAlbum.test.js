...
test("Test instantiating SpotifyAlbum", async () => {
    ...
    let payload = {
        ...
        total_tracks: 13,
        images: [
            { url: "https://cdn.album-covers.com/abcd1234", height: 640, width: 640 },
            { url: "https://cdn.album-covers.com/abcd1234_300", height: 300, width: 300 },
            { url: "https://cdn.album-covers.com/abcd1234_64", height: 64, width: 64 },
        ],
    };
    ...
    // Example of an assertion that fails.
    expect([1, 2, 3].includes(4)).toBe(true);
});
